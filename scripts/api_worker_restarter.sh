...
SBATCH_COMMAND="sbatch --dependency=singleton --time=$DURATION_HMS --qos qos --output=$OUTPUT_PATH -J $RESTART_JOB_NAME /global/cfs/cdirs/nstaff/chatbot/letMeNERSCthatForYou/scripts/api_worker.sh"
