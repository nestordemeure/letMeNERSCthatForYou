...
def chat(
    ...
    #extra= 'Given the following information: '
    #for i in range(len(chunks)):
    #    extra += chunks[i]['content']
    #extra += '. Answer the following question in detail and provide all refences: '
    #prompt = "A chat between a curious user and an artificial intelligence assistant. The assistant gives helpful, detailed, and polite answers to the user's questions. USER: "+inpput_prompt+" ASSISTANT:"   
    #prompt = ANSWERING_PROMPT + extra + prompt
    gen_params = {
            #"model": model_path,
            "prompt": prompt,
            ...
            "stop": None,#conv.stop_str,
            "stop_token_ids": None,#conv.stop_token_ids,
            "echo": False,
    }
